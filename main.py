...
# List of symbols to be analyzed. Will work for both indices and stocks.
NSE_SYMBOLS = [
    "RELIANCE", "TCS", "INFY", "HDFCBANK", "ICICIBANK", "HINDUNILVR", "KOTAKBANK",
    "LT", "SBIN", "AXISBANK", "ITC", "BAJFINANCE", "BHARTIARTL", "MARUTI", "NTPC",
    "HCLTECH", "ASIANPAINT", "SUNPHARMA", "POWERGRID", "TITAN", "ULTRACEMCO",
    "TECHM", "NESTLEIND", "BAJAJFINSV", "JSWSTEEL", "COALINDIA", "HDFCLIFE",
    "ADANIENT", "ADANIPORTS", "BRITANNIA", "CIPLA", "GRASIM", "HEROMOTOCO",
    "DIVISLAB", "DRREDDY", "EICHERMOT", "BAJAJ-AUTO", "BPCL", "HINDALCO",
    "INDUSINDBK", "UPL", "ONGC", "WIPRO", "SBILIFE", "SHREECEM", "M&M",
    "TATASTEEL", "TATAMOTORS", "APOLLOHOSP", "HDFC", "NIFTY", "BANKNIFTY",
...
def read_google_sheet_data(client, sheet_id, sheet_name):
    try:
        ...
        # Corrected to include 'EXCHANGE' in expected headers
...
if __name__ == "__main__":
    ...
    df = df[df['SYMBOL'].isin(NSE_SYMBOLS)]
    if df.empty:
