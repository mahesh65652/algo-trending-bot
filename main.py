...
def main():
    ...
    try:
        ...
        print("⚠ LIVE DATA sheet not found. Creating new one...")
        ws_live = ss.add_worksheet(title="LIVE DATA", rows="1000", cols="20")
        ws_live.update("A1:C1", [["Symbol", "Close", "Time"]])
        values = ws_live.get_all_values()
    except Exception as e:
        print("Error reading LIVE DATA:", e)
        return
