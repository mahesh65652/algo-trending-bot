...
def read_google_sheet_data(client, sheet_id, sheet_name):
    try:
        ...
        # अब यह कोड केवल SYMBOL और CLOSE कॉलम की उम्मीद करता है
        data = sheet.get_all_records(expected_headers=["SYMBOL", "CLOSE"])
...
if __name__ == "__main__":
    ...
    # टोकन जानकारी से एक्सचेंज (exch_seg) प्राप्त करें
