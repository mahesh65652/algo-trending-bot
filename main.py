...
# List of NSE index symbols to be analyzed
# You can customize this list with the symbols you want to track
NSE_INDEX_SYMBOLS = [
    "NIFTY", "BANKNIFTY", "FINNIFTY", "MIDCAPNIFTY", "SENSEX",
    "RELIANCE", "HDFCBANK", "ICICIBANK", "INFY", "HINDUNILVR",
    "TCS", "KOTAKBANK", "ITC", "LT", "SBIN",
    "BAJFINANCE", "ASIANPAINT", "BHARTIARTL", "MARUTI", "AXISBANK",
    "SUNPHARMA", "ULTRACEMCO", "TITAN", "NTPC", "ONGC"
]
...
def update_google_sheet_cell(client, sheet_id, sheet_name, cell, content):
    try:
        ...
        # Fix: Gspread's update method expects a list of lists.
        # It also has a changed order of arguments.
        if isinstance(content, list):
            content = [content]
        else:
            content = [[content]]
        ws.update(content, cell) # Updated to the correct order
...
if __name__ == "__main__":
    ...
    # Filter symbols based on the NSE_INDEX_SYMBOLS list
