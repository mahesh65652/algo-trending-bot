...
if __name__ == "__main__":
    ...
    if signals:
        update_google_sheet_cell(gs_client, GSHEET_ID, SHEET_NAME, "J2", "\n".join(signals))
        ...
        # When no signals are generated, update the cell with a message.
        update_google_sheet_cell(gs_client, GSHEET_ID, SHEET_NAME, "J2", "No signals generated.")
